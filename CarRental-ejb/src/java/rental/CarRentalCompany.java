...
public class CarRentalCompany {
    ...
    public boolean canCreateQuote(String carType, Date start, Date end, String region) {
        return this.regions.contains(region) && isAvailable(carType, start, end);
    }

    public int getNumberOfReservationsForCarType(String carType) throws ReservationException {
        int result = 0;
